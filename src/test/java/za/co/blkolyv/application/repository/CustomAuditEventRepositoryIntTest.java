...
import za.co.blkolyv.application.config.audit.AuditEventConverter;
import za.co.blkolyv.application.domain.PersistentAuditEvent;
...
import static za.co.blkolyv.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
