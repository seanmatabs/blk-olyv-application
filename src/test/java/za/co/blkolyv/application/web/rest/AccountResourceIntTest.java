...
import za.co.blkolyv.application.config.Constants;
import za.co.blkolyv.application.domain.Authority;
import za.co.blkolyv.application.domain.User;
import za.co.blkolyv.application.repository.AuthorityRepository;
import za.co.blkolyv.application.repository.UserRepository;
import za.co.blkolyv.application.security.AuthoritiesConstants;
import za.co.blkolyv.application.service.MailService;
import za.co.blkolyv.application.service.UserService;
import za.co.blkolyv.application.service.dto.PasswordChangeDTO;
import za.co.blkolyv.application.service.dto.UserDTO;
import za.co.blkolyv.application.web.rest.errors.ExceptionTranslator;
import za.co.blkolyv.application.web.rest.vm.KeyAndPasswordVM;
import za.co.blkolyv.application.web.rest.vm.ManagedUserVM;
